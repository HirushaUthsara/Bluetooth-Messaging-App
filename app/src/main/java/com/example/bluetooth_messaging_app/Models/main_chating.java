...
import com.example.bluetooth_messaging_app.devicelist;

public class main_chating extends AppCompatActivity {

    private Context context;
    private BluetoothAdapter bluetoothAdapter;
    private chating_prop chatUtils;
        ...
        public boolean handleMessage(Message message) {
            switch (message.what) {
                case MESSAGE_STATE_CHANGED:
                    switch (message.arg1) {
                        case chating_prop.STATE_NONE:
                            setState("Not Connected");
                            break;
                        case chating_prop.STATE_LISTEN:
                            setState("Not Connected");
                            break;
                        case chating_prop.STATE_CONNECTING:
                            setState("Connecting...");
                            break;
                        case chating_prop.STATE_CONNECTED:
